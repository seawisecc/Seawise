...
export async function generateMetadata({
  ...
  return {
    ...
    // Installable web app. `manifest` points at the route generated by
    // app/manifest.ts; `appleWebApp` is what lets iOS open the saved icon in
    // standalone mode instead of a Safari tab. Neither adds visible markup.
