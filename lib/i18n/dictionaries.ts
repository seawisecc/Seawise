...
const en = {
  ...
  home: {
    ...
    partnersTitle: "Businesses already running our apps.",
  ...
  fallbackPricing: [
    {
      name: "Shore",
      tagline: "Promoting one product or event, simple personal branding",
      price: "Rp 2.000.000",
      priceNote: "/ project",
      features: ["1 page (max 4-5 sections)", "1 preset theme (no colour options)", "No admin panel (we handle updates)", "Standard SEO metadata", "1x minor revision", "Optional maintenance Rp1.8M/year"],
      featured: false,
    },
    {
      name: "Reef",
      tagline: "Small businesses that need a complete company profile",
      price: "Rp 3.500.000",
      priceNote: "/ project",
      features: ["Max 5-6 sections (hero, about, products, gallery, contact)", "Choose from available presets", "Admin panel: edit text, prices, photos", "SEO plus automatic structured data", "2x major revisions", "Maintenance Rp1.8M/year"],
      featured: true,
    },
    {
      name: "Current",
      tagline: "A more personal look, distinct from your competitors",
      price: "Rp 4.500.000",
      priceNote: "/ project",
      features: ["Max 8-10 sections, reorder them yourself", "Preset plus moderate customisation (colour, layout, light animation)", "Admin panel plus section reordering", "SEO as in Reef", "Add 1 add-on (billed separately)", "2x major revisions", "Maintenance Rp1.8M/year"],
      featured: false,
    },
    {
      name: "Trench",
      tagline: "Unusual business models, or a need for full custom features",
      price: "Rp 12.000.000",
      priceNote: "/ project",
      features: ["Unlimited sections (as your needs require)", "Full custom (new vertical or theme)", "Admin panel with broader access", "SEO plus optional SEO Managed bundle discount", "1 add-on included, a second billed separately", "2x major revisions plus priority support", "Maintenance Rp1.8M/year"],
      featured: false,
    },
  ],
};
...
const id: Dictionary = {
  ...
  home: {
    ...
    partnersTitle: "Bisnis yang sudah memakai aplikasi kami.",
  ...
  fallbackPricing: [
    {
      ...
      price: "Rp 2.000.000",
      priceNote: "/ proyek",
      features: ["1 halaman (maks 4–5 section)", "1 preset tema (tanpa pilihan warna)", "Tanpa admin panel (update via kami)", "SEO metadata standar", "1× revisi minor", "Maintenance opsional Rp1,8jt/th"],
      featured: false,
    },
    {
      name: "Reef",
      ...
      price: "Rp 3.500.000",
      priceNote: "/ proyek",
      features: ["Maks 5–6 section (hero, tentang, produk, galeri, kontak)", "Pilih dari preset tersedia", "Admin panel: edit teks, harga, foto", "SEO + structured data otomatis", "2× revisi major", "Maintenance Rp1,8jt/th"],
      featured: true,
    },
    {
      name: "Current",
      ...
      price: "Rp 4.500.000",
      priceNote: "/ proyek",
      features: ["Maks 8–10 section, reorder sendiri", "Preset + kustomisasi moderat (warna/layout/animasi ringan)", "Admin + reorder section sendiri", "SEO seperti Reef", "Bisa tambah 1 add-on (charge terpisah)", "2× revisi major", "Maintenance Rp1,8jt/th"],
      featured: false,
    },
    {
      name: "Trench",
      tagline: "Model bisnis unik / butuh fitur custom penuh",
      price: "Rp 12.000.000",
      priceNote: "/ proyek",
      features: ["Section tidak dibatasi (sesuai kebutuhan)", "Full custom (vertical/tema baru)", "Admin akses lebih luas", "SEO + bisa bundling SEO Managed (diskon)", "1 add-on termasuk, add-on kedua terpisah", "2× revisi major + prioritas support", "Maintenance Rp1,8jt/th"],
      featured: false,
    },
  ],
};
