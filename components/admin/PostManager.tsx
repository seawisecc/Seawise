          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.id} className="border-t border-warm-neutral">
                <td className="px-4 py-3 font-medium text-forest-dark">{r.title}</td>
                <td className="px-4 py-3 text-forest-dark/60">/{r.slug}</td>
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan={4} className="px-4 py-8 text-center text-forest-dark/50">
                  Belum ada artikel.
                </td>
              </tr>
            )}
